...
📌 Project Overview
This project focuses on analyzing pizza sales data using MySQL to derive meaningful business insights. SQL queries are used to explore revenue, order trends, and best-selling pizzas, helping understand customer behavior and sales performance.
